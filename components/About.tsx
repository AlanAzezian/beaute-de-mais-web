...
export default function About() {
  ...
  return (
    ...
    >
      {/* Visual card */}
      <div className="reveal" ref={setRef(0) as any}>
        <div
          className="relative min-h-[340px] md:aspect-[3/4] flex items-end overflow-hidden"
        ...
        >
          ...
          {/* Large A */}
          <span
            className="absolute top-6 right-6 font-cormorant text-[8rem] font-light leading-none pointer-events-none select-none"
            style={{ color: 'rgba(201,168,212,0.06)' }}
          >
            A
          </span>
          {/* SVG Logo */}
          ...
          >
            <div className="font-cormorant text-[2.8rem] text-lavender font-light">4+</div>
            <div className="text-[0.6rem] tracking-[0.2em] uppercase text-mid-gray mt-1">
              Años de experiencia
            </div>
          </div>
        </div>
      ...
      <div className="reveal flex flex-col justify-center" ref={setRef(1) as any}>
        <p className="text-[0.6rem] tracking-[0.3em] uppercase text-lavender mb-6">Sobre mí</p>
        <h2 className="font-cormorant text-[clamp(2rem,5vw,3.5rem)] font-light leading-[1.15] mb-8">
          Arte que <em className="italic text-lavender">habla</em>
          <br />
          por tus manos
        </h2>
        <p className="text-[0.85rem] leading-[1.85] text-mid-gray mb-5">
        ...
        <p className="text-[0.85rem] leading-[1.85] text-mid-gray mb-12">
        ...
        <div className="flex gap-10">
          {[
            ...
            <div key={label}>
              <div className="font-cormorant text-[2.5rem] text-lavender font-light">{num}</div>
              <div className="text-[0.65rem] tracking-[0.15em] uppercase text-mid-gray mt-1">
                {label}
              </div>
            </div>
          ))}
